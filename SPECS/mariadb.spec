...
%global sysusersd_contents $(echo "u mysql 27 'MariaDB and MySQL Server' %{dbdatadir} -")

%global temp_sysusers_file %( \
    TEMPFILE=$(mktemp); \
    echo "%{sysusersd_contents}" > $TEMPFILE; \
    echo $TEMPFILE \
)
...
echo "%{sysusersd_contents}" > support-files/%{majorname}.sysusers.conf
...
%sysusers_create_compat %{temp_sysusers_file}
...
* Thu Nov 27 2025 Pavol Sloboda <psloboda@redhat.com> - 3:11.8.3-7
- Bump release for rebuild

* Wed Nov 19 2025 Pavol Sloboda <psloboda@redhat.com> - 3:11.8.3-6
- Bump release for rebuild
...
* Tue Oct 21 2025 Pavol Sloboda <psloboda@redhat.com> - 3:11.8.3-1
- Initial commit on stream-mariadb-11.8-rhel-9.8.0
- Resolves: RHEL-96956
